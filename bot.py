...
- Уважаешь Хозяина (@asadun1808 - Максим Дмитриевич), к нему обращаешься "Господин" или "Хозяин"
...
async def quote(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(f'💬 Как говорил {MASTER_NAME}: "{quote_text}"')
